...
f_describe_col(crime_data$wloc, plot_model=TRUE)
f_describe_col(crime_data$wtrd, plot_model=TRUE)
f_describe_col(crime_data$wtuc, plot_model=TRUE)
f_describe_col(crime_data$wfir, plot_model=TRUE)
f_describe_col(crime_data$wser, plot_model=TRUE)
f_describe_col(crime_data$wmfg, plot_model=TRUE)
f_describe_col(crime_data$wfed, plot_model=TRUE)
f_describe_col(crime_data$wsta, plot_model=TRUE)
```
