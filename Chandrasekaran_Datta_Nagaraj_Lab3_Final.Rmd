...
The model shows a fit of about 0.72 as measured by adjusted $R^2$.  There are a few (non-normal) outliers at the bottom left of the QQ-plot due to data skew that we could not correct via transformations.
...
The fit improves to 0.77 (adjusted $R^2$).  This is because some of the newly added variables are more normal in distribution (=less skew).
...
This makes almost no difference to the fit (adjusted $R^2$).
