...
* $prbarr$, observation #51: ratio of arrests to offenses is 1.1. It doesn't seem likely that a person will be arrested more than once for the same offense (unless of course we mix in criminals escaping). We further observed that this outlier single handedly affects regression line on crime rate. 
* $density$, observation #79: extremely low density. We believe such small number of people reported per square mile is likely to be erroneous
* $wser$, observation #84: extremely high service wages. This observation happened to be an order of magnitude larger, that we deemed likely to be due to data entry error
...
The observations above are questionable and affect our model because of their high influence.  We will thus remove them from consideration.
