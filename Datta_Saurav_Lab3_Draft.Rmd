...
The regression lines is close to 0 residual. Thiis indicates there is a linear relationship among logcrmrte with  logpolpc + log1pdensity.
...
The Normal QQ plot is roughly on a stright line. This indicates that our data has been sourced from a normal distribution 
...
The regression lines is close to 0 residual. Thiis indicates there is a linear relationship among logcrmrte with  wcon.
The Normal QQ plot is roughly on a stright line. This indicates that our data has been sourced from a normal distribution 
...
The regression lines is close to 0 residual. Thiis indicates there is a linear relationship between logcrmrte and (logpolpc + log1pdensity +prbarr + wcon + wser  + wfed + wloc)
